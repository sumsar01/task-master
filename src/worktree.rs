...
/// Build the prompt injected into the opencode agent when spawning a dev session.
///
/// Appends mandatory PR-workflow instructions so agents always follow the
/// correct push → pr create → notify sequence.
